...
output_model_path = '../models/face_expression_multiMood.hdf5'
output_plot_path = '../plots/face_expression_multiMood.png'
...
(trainX, testX, trainY, testY) = train_test_split(data,
	labels, test_size=0.02, stratify=labels, random_state=42)
